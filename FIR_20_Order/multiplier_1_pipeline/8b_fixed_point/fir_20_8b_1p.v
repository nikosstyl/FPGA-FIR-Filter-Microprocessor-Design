...
// Generated on: 2023-06-21 23:45:19
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
//Module Architecture: fir_20_8b_1p
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  ...
  reg  signed [15:0] product19; // sfix16_En8
  reg  signed [7:0] delay_pipeline_18_pipe; // sfix8
  ...
  reg  signed [15:0] product17; // sfix16_En8
  reg  signed [7:0] delay_pipeline_16_pipe; // sfix8
  ...
  reg  signed [15:0] product5; // sfix16_En8
  reg  signed [7:0] delay_pipeline_4_pipe; // sfix8
  ...
  always @ (posedge clk or posedge reset)
    begin: temp_process1
      if (reset == 1'b1) begin
        delay_pipeline_18_pipe <= 0;
      end
      else begin
        if (clk_enable == 1'b1) begin
          delay_pipeline_18_pipe <= delay_pipeline[18];
        end
      end
    end // temp_process1
  always @ (posedge clk or posedge reset)
  ...
  always @ (posedge clk or posedge reset)
    begin: temp_process4
      if (reset == 1'b1) begin
        delay_pipeline_16_pipe <= 0;
      end
      else begin
        if (clk_enable == 1'b1) begin
          delay_pipeline_16_pipe <= delay_pipeline[16];
        end
      end
    end // temp_process4
  always @ (posedge clk or posedge reset)
  ...
  always @ (posedge clk or posedge reset)
    begin: temp_process19
      if (reset == 1'b1) begin
        delay_pipeline_4_pipe <= 0;
      end
      else begin
        if (clk_enable == 1'b1) begin
          delay_pipeline_4_pipe <= delay_pipeline[4];
        end
      end
    end // temp_process19
  always @ (posedge clk or posedge reset)
