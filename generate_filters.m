...
spec_firMinimumOrder = fdesign.lowpass('N,Fp,Fst,Ap', 3, 8e+3, 9600, 60, 46e+3);
...
%% Create filters
firMinimumOrder = design(spec_firMinimumOrder, 'FIR', 'SystemObject', true);
fir20Order = design(spec_fir20Order, 'FIR', 'SystemObject', true);
fir30Order = design(spec_fir30Order, 'FIR', 'SystemObject', true);
