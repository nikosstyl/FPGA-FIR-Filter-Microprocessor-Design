...
// Generated on: 2023-06-22 11:56:31
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
//Module Architecture: fir_30_8b_1p
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  ...
  reg  signed [15:0] product29; // sfix16_En8
  reg  signed [7:0] delay_pipeline_28_pipe; // sfix8
  wire signed [15:0] product29_pipe; // sfix16_En8
  reg  signed [15:0] product28; // sfix16_En8
  reg  signed [7:0] delay_pipeline_27_pipe; // sfix8
  wire signed [15:0] product28_pipe; // sfix16_En8
  reg  signed [15:0] product27; // sfix16_En8
  reg  signed [7:0] delay_pipeline_26_pipe; // sfix8
  wire signed [15:0] product27_pipe; // sfix16_En8
  reg  signed [15:0] product26; // sfix16_En8
  reg  signed [7:0] delay_pipeline_25_pipe; // sfix8
  wire signed [15:0] product26_pipe; // sfix16_En8
  wire signed [8:0] mulpwr2_temp; // sfix9
  reg  signed [15:0] product25; // sfix16_En8
  reg  signed [7:0] delay_pipeline_24_pipe; // sfix8
  ...
  reg  signed [15:0] product7; // sfix16_En8
  reg  signed [7:0] delay_pipeline_6_pipe; // sfix8
  ...
  always @ (posedge clk or posedge reset)
    begin: temp_process1
      if (reset == 1'b1) begin
        delay_pipeline_28_pipe <= 0;
      end
      else begin
        if (clk_enable == 1'b1) begin
          delay_pipeline_28_pipe <= delay_pipeline[28];
        end
      end
    end // temp_process1
  always @ (posedge clk or posedge reset)
  ...
  always @ (posedge clk or posedge reset)
    begin: temp_process3
      if (reset == 1'b1) begin
        delay_pipeline_27_pipe <= 0;
      end
      else begin
        if (clk_enable == 1'b1) begin
          delay_pipeline_27_pipe <= delay_pipeline[27];
        end
      end
    end // temp_process3
  always @ (posedge clk or posedge reset)
  ...
  always @ (posedge clk or posedge reset)
    begin: temp_process5
      if (reset == 1'b1) begin
        delay_pipeline_26_pipe <= 0;
      end
      else begin
        if (clk_enable == 1'b1) begin
          delay_pipeline_26_pipe <= delay_pipeline[26];
        end
      end
    end // temp_process5
  always @ (posedge clk or posedge reset)
  ...
  always @ (posedge clk or posedge reset)
    begin: temp_process7
      if (reset == 1'b1) begin
        delay_pipeline_25_pipe <= 0;
      end
      else begin
        if (clk_enable == 1'b1) begin
          delay_pipeline_25_pipe <= delay_pipeline[25];
        end
      end
    end // temp_process7
  always @ (posedge clk or posedge reset)
  ...
  always @ (posedge clk or posedge reset)
    begin: temp_process9
      if (reset == 1'b1) begin
        delay_pipeline_24_pipe <= 0;
      end
      else begin
        if (clk_enable == 1'b1) begin
          delay_pipeline_24_pipe <= delay_pipeline[24];
        end
      end
    end // temp_process9
  always @ (posedge clk or posedge reset)
